...
Every failure inside coherence-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`coherence.cli._output`,
...
# Exit-code policy. Documented in ``coherence-cli learn`` output.
# 0      = success
