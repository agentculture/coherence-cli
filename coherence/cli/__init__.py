...
from coherence.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/coherence-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = _CliArgumentParser(
        prog="coherence-cli",
        description="coherence-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
