"""``coherence-cli overview`` — read-only descriptive snapshot of the agent.
...
:mod:`coherence.cli._commands.cli`).
...
from coherence.cli._commands.whoami import report
...
_VERBS = [
    ...
    "frames <measurement.json> — inspect/diff the semantic frame behind a "
    "measurement (see 'coherence frames')",
    "assess <file> — run every applicable coherence domain on an artifact "
